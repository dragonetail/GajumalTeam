...
@IBDesignable class CustomHeader: UIView {
    var delegate: OnClickDelegate?
    var rightDelegate: RightBtnClickDelegate?
    var leftDelegate: LeftBtnClickDelegate?
    ...
    @IBAction func rightButtonAction(_ sender: AnyObject) {
        rightDelegate?.onRightBtnClick()
    }
    
    @IBAction func leftButton(_ sender: AnyObject) {
        leftDelegate?.onLeftBtnClick()
    }
